...
export interface SpathaGettersInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "feeRecipient"
...
export interface SpathaGetters extends BaseContract {
  connect(runner?: ContractRunner | null): SpathaGetters;
  waitForDeployment(): Promise<this>;

  interface: SpathaGettersInterface;
