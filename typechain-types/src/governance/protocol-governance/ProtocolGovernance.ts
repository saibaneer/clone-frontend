...
export interface ProtocolGovernanceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface ProtocolGovernance extends BaseContract {
  connect(runner?: ContractRunner | null): ProtocolGovernance;
  waitForDeployment(): Promise<this>;

  interface: ProtocolGovernanceInterface;
