...
export interface MarketBasedGovernorVotesInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface MarketBasedGovernorVotes extends BaseContract {
  connect(runner?: ContractRunner | null): MarketBasedGovernorVotes;
  waitForDeployment(): Promise<this>;

  interface: MarketBasedGovernorVotesInterface;
