...
export interface MarketBasedGovernorCountingSimpleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface MarketBasedGovernorCountingSimple extends BaseContract {
  connect(runner?: ContractRunner | null): MarketBasedGovernorCountingSimple;
  waitForDeployment(): Promise<this>;

  interface: MarketBasedGovernorCountingSimpleInterface;
