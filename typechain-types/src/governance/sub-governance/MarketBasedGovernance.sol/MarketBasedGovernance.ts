...
export interface MarketBasedGovernanceInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
  ...
  encodeFunctionData(
    ...
    values: [BytesLike, AddressLike[], BigNumberish[], BytesLike[], string]
  ): string;
  encodeFunctionData(
...
export namespace MarketProposalCreatedEvent {
  export type InputTuple = [
...
export interface MarketBasedGovernance extends BaseContract {
  connect(runner?: ContractRunner | null): MarketBasedGovernance;
  waitForDeployment(): Promise<this>;

  interface: MarketBasedGovernanceInterface;
  ...
  proposalDetails: TypedContractMethod<
    [proposalId: BigNumberish],
    [[string, string[], bigint[], string[], string] & { marketId: string }],
    "view"
  >;
  ...
  >;
  getEvent(
    key: "MarketProposalCreated"
  ): TypedContractEvent<
    MarketProposalCreatedEvent.InputTuple,
    MarketProposalCreatedEvent.OutputTuple,
    MarketProposalCreatedEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "MarketProposalCreated(uint256,address,bytes32,address[],uint256[],string[],bytes[],uint256,uint256,string)": TypedContractEvent<
      MarketProposalCreatedEvent.InputTuple,
      MarketProposalCreatedEvent.OutputTuple,
      MarketProposalCreatedEvent.OutputObject
    >;
    MarketProposalCreated: TypedContractEvent<
      MarketProposalCreatedEvent.InputTuple,
      MarketProposalCreatedEvent.OutputTuple,
      MarketProposalCreatedEvent.OutputObject
    >;
