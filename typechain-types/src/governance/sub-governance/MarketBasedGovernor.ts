...
export interface MarketBasedGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface MarketBasedGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): MarketBasedGovernor;
  waitForDeployment(): Promise<this>;

  interface: MarketBasedGovernorInterface;
