...
export interface IMarketBasedGovernorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "COUNTING_MODE"
...
export interface IMarketBasedGovernor extends BaseContract {
  connect(runner?: ContractRunner | null): IMarketBasedGovernor;
  waitForDeployment(): Promise<this>;

  interface: IMarketBasedGovernorInterface;
