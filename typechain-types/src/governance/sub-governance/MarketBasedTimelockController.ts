...
export interface MarketBasedTimelockControllerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CANCELLER_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MarketBasedTimelockController extends BaseContract {
  connect(runner?: ContractRunner | null): MarketBasedTimelockController;
  waitForDeployment(): Promise<this>;

  interface: MarketBasedTimelockControllerInterface;
