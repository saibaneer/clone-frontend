...
export interface MarketBasedGovernorSettingsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BALLOT_TYPEHASH"
      | "CLOCK_MODE"
...
export interface MarketBasedGovernorSettings extends BaseContract {
  connect(runner?: ContractRunner | null): MarketBasedGovernorSettings;
  waitForDeployment(): Promise<this>;

  interface: MarketBasedGovernorSettingsInterface;
