...
export interface IFallbackPriceOracleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "BASE_CURRENCY"
      | "BASE_CURRENCY_UNIT"
...
export interface IFallbackPriceOracle extends BaseContract {
  connect(runner?: ContractRunner | null): IFallbackPriceOracle;
  waitForDeployment(): Promise<this>;

  interface: IFallbackPriceOracleInterface;
